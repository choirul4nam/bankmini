...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2020 at 02:46 PM
...
CREATE TABLE `tb_jurnal` (
  ...
  `nominal_debet` double NOT NULL,
  `nominal_kredit` double NOT NULL,
  `transaksi_debet` double NOT NULL,
  `transaksi_kredit` double NOT NULL,
...
CREATE TABLE `tb_kaskeluar` (
  ...
  `kode_kas_keluar` char(13) DEFAULT NULL,
...
INSERT INTO `tb_kaskeluar` (`tgltransaksi`, `kode_coa`, `keterangan`, `nominal`, `kode_kas_keluar`, `id_user`, `status_jurnal`) VALUES
('2020-09-21 01:17:57', '100', 'kas keluar', 200000, 'KK202009291', 1, '0');
...
CREATE TABLE `tb_kasmasuk` (
  ...
  `keterangan` varchar(255) DEFAULT NULL,
  `nominal` int(11) DEFAULT NULL,
  `kode_kas_masuk` char(13) DEFAULT NULL,
  `id_user` int(11) DEFAULT NULL,
...
INSERT INTO `tb_kasmasuk` (`tgltransaksi`, `kode_coa`, `keterangan`, `nominal`, `kode_kas_masuk`, `id_user`, `statusjurnal`) VALUES
('2020-09-28 12:51:22', '100', 'kas sekloh', 2000000, 'KM202009291', 1, '0'),
('2020-09-03 12:55:33', '200', 'a', 11, 'KM202009292', 1, '0'),
('2020-09-29 12:56:39', '200', 'lollool', 200000000, 'KM202009292', 1, '0');
...
INSERT INTO `tb_kelas` (`id_kelas`, `kelas`, `status`, `id_user`, `tglupdate`) VALUES
(1, 'X IPS 1', 'aktif', 1, '2020-09-21 03:13:58'),
(2, 'X IPS 2', 'aktif', 1, '2020-09-19 10:10:07'),
(3, 'X IPS 3', 'aktif', 1, '2020-09-19 10:10:25'),
(4, 'XI IPA 1', 'tidak aktif', 1, '2020-09-20 09:44:44'),
(5, 'XII IPA 2', 'tidak aktif', 1, '2020-09-21 07:42:17'),
(6, 'X IPA 1', 'aktif', 1, '2020-09-23 10:27:21');
...
(11, '200', 'laaaa', 'aktiva tetap ', '0', '1', '0', 1, '2020-09-28 06:43:39'),
(15, '100', 'loooo', 'aktiva bebas', '1', '0', '0', 1, '2020-09-29 00:20:25'),
(16, '10000', 'lol', 'a oo', '0', '1', '0', 1, '2020-09-29 08:09:58');
...
CREATE TABLE `tb_mastertransaksi` (
  ...
  `debet` enum('siswa','koperasi') DEFAULT NULL,
  `kredit` enum('siswa','koperasi') DEFAULT NULL,
...
CREATE TABLE `tb_siswa` (
  ...
  `tgl_update` datetime NOT NULL,
  `id_user` int(11) NOT NULL,
  `status` enum('aktif','alumni','tidak aktif') NOT NULL,
  `id_tipeuser` int(11) NOT NULL,
...
('4531', 'ABDUL HAFIIDH EKA PUTRA', 'JL.Contoh Alamat 1', 'MALANG', '2020-09-23', '35', '3578', '3578280', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID101'),
('4534', 'ACHMAD DANDI BHAKTI SAMODRA', 'JL.Contoh Alamat 2', 'MALANG', '2020-09-24', '35', '3578', '3578280', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID102'),
('4546', 'AISYAH EKA FITRIANI', 'JL.Contoh Alamat 3', 'SURABAYA', '2020-09-25', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID103'),
('4569', 'APRINDO WAHYU SATRIO', 'JL.Contoh Alamat 4', 'SURABAYA', '2020-09-26', '35', '3578', '3578280', 'Laki-laki', 1, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID104'),
('4608', 'DIAH NUR FADILAH', 'JL.Contoh Alamat 5', 'SURABAYA', '2020-09-27', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID105'),
('4622', 'DURROTUN FADHILAH MAULIDYA', 'JL.Contoh Alamat 6', 'SURABAYA', '2020-09-28', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID106'),
('4626', 'DWI FITRIASIH', 'JL.Contoh Alamat 7', 'BOJONEGORO', '2020-09-29', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID107'),
('4633', 'EIFFEL BINTANG RACHMALIA', 'JL.Contoh Alamat 8', 'BOJONEGORO', '2020-09-30', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID108'),
('4644', 'ERINDA EKA LARASATI', 'JL.Contoh Alamat 9', 'BOJONEGORO', '2020-10-01', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID109'),
('4687', 'IKA LAILIYATUL MUNIROH', 'JL.Contoh Alamat 10', 'BOJONEGORO', '2020-10-02', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID110'),
('4697', 'KHOIRUDIN FEBRIAN NUR  HABIB', 'JL.Contoh Alamat 11', 'BOJONEGORO', '2020-10-03', '35', '3578', '3578280', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID111'),
('4698', 'KHOIRUN NISA\'', 'JL.Contoh Alamat 12', 'KEDIRI', '2020-10-04', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID112'),
('4717', 'MAULIA AZZAHRA JASMINE', 'JL.Contoh Alamat 13', 'KEDIRI', '2020-10-05', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID113'),
('4721', 'MICHELLE AUREL TESSALONIKA', 'JL.Contoh Alamat 14', 'KEDIRI', '2020-10-06', '35', '3578', '3578280', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID114'),
('4730', 'MOCHAMAD ROZAQ BINTANG HIDAYATULLOH', 'JL.Contoh Alamat 15', 'KEDIRI', '2020-10-07', '35', '3578', '3578280', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID115'),
('4738', 'MUHAMMAD ALIYUDIN ATAMSYAH', 'JL.Contoh Alamat 16', 'BLITAR', '2020-10-08', '35', '3578', '3578280', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID116'),
('4741', 'MUHAMMAD FATKUR ROHMAN', 'JL.Contoh Alamat 17', 'BLITAR', '2020-10-09', '35', '3578', '3578280', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID117'),
('4744', 'MUHAMMAD IRGY KURNIAWAN UMAR', 'JL.Contoh Alamat 18', 'BLITAR', '2020-10-10', '35', '3578', '3578280', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID118'),
('4746', 'NADINDRA AQILAH PRYATAMA', 'JL.Contoh Alamat 19', 'BLITAR', '2020-10-11', '35', '3578', '3578150', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID119'),
('4783', 'PUTERI WIKAN AGUSTIN', 'JL.Contoh Alamat 20', 'BLITAR', '2020-10-12', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID120'),
('4796', 'RANGGA ADI PUTRA', 'JL.Contoh Alamat 21', 'BLITAR', '2020-10-13', '35', '3578', '3578150', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID121'),
('4805', 'REZA APRIANDI PRATAMA FIRMANSYAH', 'JL.Contoh Alamat 22', 'LAMONGAN', '2020-10-14', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID122'),
('4815', 'RISYA FIRDAUS', 'JL.Contoh Alamat 23', 'LAMONGAN', '2020-10-15', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID123'),
('4821', 'SANDIKA LYANDRA PRASETYO', 'JL.Contoh Alamat 24', 'LAMONGAN', '2020-10-16', '35', '3578', '3578150', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID124'),
('4831', 'SHERCYVIA YONITA REFLYN', 'JL.Contoh Alamat 25', 'LAMONGAN', '2020-10-17', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID125'),
('4857', 'TAUFIQ TRI WINARDI', 'JL.Contoh Alamat 26', 'LAMONGAN', '2020-10-18', '35', '3578', '3578150', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID126'),
('4859', 'THALIA DWINDA MAYANGSARI', 'JL.Contoh Alamat 27', 'JEMBER', '2020-10-19', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID127'),
('4861', 'TIRZA WAHONO', 'JL.Contoh Alamat 28', 'JEMBER', '2020-10-20', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID128'),
('4885', 'YESA DWI PRATIWI', 'JL.Contoh Alamat 29', 'JEMBER', '2020-10-21', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID129'),
('4888', 'YHOAN ATMA BARATA', 'JL.Contoh Alamat 30', 'JEMBER', '2020-10-22', '35', '3578', '3578150', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID130'),
('4890', 'YOEL RAPHAEL PERES', 'JL.Contoh Alamat 31', 'JEMBER', '2020-10-23', '35', '3578', '3578150', 'Laki-laki', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID131'),
('4897', 'ZAHRA NAYLA PUTRI', 'JL.Contoh Alamat 32', 'JEMBER', '2020-10-24', '35', '3578', '3578150', 'Perempuan', 6, '2020-09-24 08:46:55', 1, 'aktif', 2, 'siswa123', 'RFID132'),
('8797', 'ssadadasdasd', 'asdasd', 'asdasd', '2020-10-24', '61', '6109', '6109070', 'Perempuan', 2, '2020-09-24 08:46:35', 1, 'tidak aktif', 2, 'siswa123', '852147963');
...
(1, 'admin', 'Administator', ' Jl.Kandanganl', '17', '1702', '1702032', '084563252135', 1, 'aktif', '2020-09-21 12:52:03', 1, 'admin'),
...
(5, 'asdd', 'Dani Cahya', 'qwe', '53', '5318', '5318040', '085265432589', 2, 'aktif', '2020-09-29 02:15:11', 1, 'pegawai123'),
...
(8, 3, 'Jurnal', 'jurnal/', 'aktif'),
(9, 3, 'Buku Pembantu', 'bukupembantu/', 'aktif'),
(10, 3, 'Kas Keluar', 'kaskeluar/', 'aktif'),
(11, 3, 'Kas Masuk', 'kasmasuk/', 'aktif'),
(12, 3, 'Master COA', 'mastercoa/', 'aktif');
...
(3, '2020-09-21', '2021-09-21', 1, '2020-09-21 07:39:48');
...
(0, 'siswa', NULL, 4569, 19, 'spp-tanggal-no', 'PEMBAYARAN SPP SISWA BULAN JANUARI', 300000, '0', 1, '2020-09-27 12:22:44', 'aktif'),
(3, 'staf', 2, NULL, 20, 'mbbs-tanggal-no', 'MODAL BAHAN BAJU SISWA, UNTUK SISWA', 2850000, '0', 1, '2020-09-26 06:28:10', 'aktif'),
(5, 'siswa', NULL, 4608, 18, 'isisaldo-tanggal-no', 'ISI SALDO KARTU KREDIT SISWA', 1000000, '0', 1, '2020-09-27 12:27:49', 'tidak aktif'),
(6, 'staf', 5, NULL, 20, 'mbbs-tanggal-no', 'MODAL BAHAN BAJU SISWA, UNTUK SISWA', 2850000, '0', 1, '2020-09-27 12:35:23', 'tidak aktif'),
(7, 'siswa', NULL, 4531, 0, '', 'asd', 123, '0', 1, '2020-09-28 09:01:45', 'aktif'),
(10, 'staf', 1, NULL, 20, 'mbbs-tanggal-no', 'MODAL BAHAN BAJU SISWA, UNTUK SISWA', 2850000, '0', 1, '2020-09-28 09:14:30', 'aktif'),
(11, 'siswa', NULL, 4569, 18, 'isisaldo-tanggal-no', 'ISI SALDO KARTU KREDIT SISWA', 1000000, '0', 1, '2020-09-28 05:23:07', 'aktif'),
(12, 'siswa', NULL, 4531, 18, 'isisaldo-tanggal-no', 'ISI SALDO KARTU KREDIT SISWA', 1000000, '0', 1, '2020-09-29 11:20:49', 'aktif'),
(13, 'siswa', NULL, 4546, 19, 'spp-tanggal-no', 'PEMBAYARAN SPP SISWA BULAN JANUARI', 300000, '0', 1, '2020-09-29 11:21:22', 'aktif');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_siswa`  AS  select `tb_siswa`.`namasiswa` AS `namasiswa`,`tb_siswa`.`nis` AS `nis`,`tb_siswa`.`alamat` AS `alamat`,`tb_siswa`.`jk` AS `jk`,`tb_siswa`.`status` AS `status`,`tb_siswa`.`password` AS `password`,`tb_siswa`.`tempat_lahir` AS `tempat_lahir`,`tb_siswa`.`tgl_lahir` AS `tgl_lahir`,`tb_siswa`.`id_kelas` AS `id_kelas`,`tb_siswa`.`rfid` AS `rfid`,`tb_kecamatan`.`kecamatan` AS `kecamatan`,`tb_kota`.`id_kota` AS `id_kota`,`tb_kota`.`name_kota` AS `name_kota`,`tb_provinsi`.`id_provinsi` AS `id_provinsi`,`tb_provinsi`.`name_prov` AS `name_prov`,`tb_kelas`.`kelas` AS `kelas`,`tb_kelas`.`tglupdate` AS `tglupdate` from ((((`tb_siswa` join `tb_kecamatan` on(`tb_siswa`.`kecamatan` = `tb_kecamatan`.`id_kecamatan`)) join `tb_kota` on(`tb_siswa`.`kota` = `tb_kota`.`id_kota`)) join `tb_provinsi` on(`tb_siswa`.`provinsi` = `tb_provinsi`.`id_provinsi`)) join `tb_kelas` on(`tb_siswa`.`id_kelas` = `tb_kelas`.`id_kelas`)) ;
...
--
ALTER TABLE `tb_mastercoa`
  MODIFY `id_coa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tb_mastertransaksi`
--
ALTER TABLE `tb_mastertransaksi`
  MODIFY `id_mastertransaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `tb_tipeuser`
  MODIFY `id_tipeuser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_userlog`
  MODIFY `id_userlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
COMMIT;

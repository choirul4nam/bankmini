...
-- Dumping data for table db_bms.tb_akses: ~25 rows (approximately)
/*!40000 ALTER TABLE `tb_akses` DISABLE KEYS */;
REPLACE INTO `tb_akses` (`id_akses`, `id_submenu`, `id_tipeuser`, `view`, `add`, `edit`, `delete`) VALUES
	(2, 2, 1, '1', '1', '1', '1'),
	(3, 3, 1, '1', '1', '1', '1'),
	(4, 4, 1, '1', '1', '1', '1'),
	(5, 5, 1, '1', '1', '1', '1'),
...
-- Dumping data for table db_bms.tb_historikas: ~3 rows (approximately)
/*!40000 ALTER TABLE `tb_historikas` DISABLE KEYS */;
REPLACE INTO `tb_historikas` (`id_histori_kas`, `kode_kas`, `jenis`, `nominal`, `saldo`, `tgltransaksi`) VALUES
	(45, 'KM101020200001', 'kas masuk', 10, 10, '2020-10-01'),
	(46, 'KK101020200001', 'kas keluar', 5, -5, '2020-10-01'),
	(47, 'KM201020200002', 'kas masuk', 60000000, 59999995, '2020-10-20');
/*!40000 ALTER TABLE `tb_historikas` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_jurnal: ~5 rows (approximately)
/*!40000 ALTER TABLE `tb_jurnal` DISABLE KEYS */;
REPLACE INTO `tb_jurnal` (`id_jurnal`, `tipe_transaksi`, `kode_coa_debet`, `kode_coa_kredit`, `nominal_debet`, `nominal_kredit`, `transaksi_debet`, `transaksi_kredit`, `id_user`, `tgl_update`) VALUES
	(18, 'kk', '4', '1', 5, 5, '', '16', 1, '2020-10-22 05:15:08'),
	(20, 'transaksi', '1200', '2', 300000, 300000, '63', '', 1, '2020-10-28 05:48:58'),
	(21, 'transaksi', '4', '1', 1000000, 1000000, '', '64', 1, '2020-10-28 05:54:36'),
	(22, 'kk', '4', '1', 5, 5, '', '16', 1, '2020-10-28 05:55:02'),
	(23, 'km', '1200', '1', 60000000, 60000000, '38', '', 1, '2020-10-28 05:55:39');
...
-- Dumping data for table db_bms.tb_kaskeluar: ~1 rows (approximately)
/*!40000 ALTER TABLE `tb_kaskeluar` DISABLE KEYS */;
REPLACE INTO `tb_kaskeluar` (`id_kk`, `tgltransaksi`, `keterangan`, `nominal`, `kode_kas_keluar`, `id_user`, `status_jurnal`) VALUES
	(16, '2020-10-01 01:07:21', '-', 5, 'KK101020200001', 1, '1');
/*!40000 ALTER TABLE `tb_kaskeluar` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_kasmasuk: ~2 rows (approximately)
/*!40000 ALTER TABLE `tb_kasmasuk` DISABLE KEYS */;
REPLACE INTO `tb_kasmasuk` (`id_km`, `tgltransaksi`, `keterangan`, `nominal`, `kode_kas_masuk`, `id_user`, `statusjurnal`) VALUES
	(37, '2020-10-01 01:07:03', '-', 10, 'KM101020200001', 1, '0'),
	(38, '2020-10-20 05:12:28', '-', 60000000, 'KM201020200002', 1, '1');
/*!40000 ALTER TABLE `tb_kasmasuk` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_kecamatan: ~7.093 rows (approximately)
/*!40000 ALTER TABLE `tb_kecamatan` DISABLE KEYS */;
REPLACE INTO `tb_kecamatan` (`id_kecamatan`, `id_kota`, `kecamatan`) VALUES
...
-- Dumping data for table db_bms.tb_kelas: ~8 rows (approximately)
/*!40000 ALTER TABLE `tb_kelas` DISABLE KEYS */;
REPLACE INTO `tb_kelas` (`id_kelas`, `kelas`, `status`, `id_user`, `tglupdate`) VALUES
	(1, 'X IPS 1', 'aktif', 1, '2020-09-21 03:13:58'),
	(2, 'X IPS 2', 'aktif', 1, '2020-09-19 10:10:07'),
	(3, 'X IPS 3', 'aktif', 1, '2020-09-19 10:10:25'),
	(5, 'XII IPA 2', 'aktif', 1, '2020-10-26 01:59:18'),
	(7, 'X IPA 1', 'aktif', 1, '2020-10-28 03:04:06'),
	(8, 'XI IPA 1', 'aktif', 1, '2020-10-25 03:51:30'),
	(9, 'XII IPA 1', 'aktif', 1, '2020-10-26 01:58:11'),
	(11, 'X IPA 2', 'aktif', 1, '2020-10-28 02:56:13');
...
-- Dumping data for table db_bms.tb_kota: ~514 rows (approximately)
/*!40000 ALTER TABLE `tb_kota` DISABLE KEYS */;
REPLACE INTO `tb_kota` (`id_kota`, `id_provinsi`, `name_kota`) VALUES
...
-- Dumping data for table db_bms.tb_mastercoa: ~5 rows (approximately)
/*!40000 ALTER TABLE `tb_mastercoa` DISABLE KEYS */;
REPLACE INTO `tb_mastercoa` (`id_coa`, `kode_coa`, `akun`, `keterangan`, `neraca`, `perubahan_modal`, `laba_rugi`, `id_user`, `tglupdate`) VALUES
	(11, '2', 'Akun 2', 'aktiva tetap  ', '0', '1', '0', 1, '2020-10-01 04:44:54'),
	(15, '1', 'Akun 1', 'aktiva bebas ', '1', '0', '0', 1, '2020-10-01 04:44:41'),
	(16, '3', 'Akun 3', 'a oo  ', '0', '1', '0', 1, '2020-10-01 04:45:44'),
	(17, '4', 'Akun 4', 'Akun 4', '1', '1', '1', 1, '2020-10-01 05:39:56'),
	(18, '1200', 'Utang', 'Hutang Piutang', '0', '0', '0', 1, '2020-10-09 06:32:35');
/*!40000 ALTER TABLE `tb_mastercoa` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_mastertransaksi: ~7 rows (approximately)
/*!40000 ALTER TABLE `tb_mastertransaksi` DISABLE KEYS */;
REPLACE INTO `tb_mastertransaksi` (`id_mastertransaksi`, `kodetransaksi`, `debet`, `kredit`, `kategori`, `deskripsi`, `nominal`, `id_user`, `status`, `tgl_update`) VALUES
	(18, 'isisaldo-tanggal-no', '', 'siswa', 'ISI SALDO (Siswa)', 'ISI SALDO KARTU KREDIT SISWA', 1000000, 1, 'aktif', '2020-09-26 09:40:19'),
	(19, 'spp-tanggal-no', 'siswa', 'koperasi', 'SPP BULAN JANUARI (Siswa)', 'PEMBAYARAN SPP SISWA BULAN JANUARI', 300000, 1, 'aktif', '2020-09-26 10:24:32'),
	(20, 'mbbs-tanggal-no', 'koperasi', '', 'MODAL BAHAN BAJU SISWA(Koperasi)', 'MODAL BAHAN BAJU SISWA, UNTUK SISWA', 2850000, 1, 'aktif', '2020-09-26 09:43:32'),
	(21, 'utang-tanggal-no', 'siswa', 'koperasi', 'Utang Baju Siswa', 'Pembayaran hutang baju siswa', 250000, 1, 'aktif', '2020-10-09 11:30:32'),
	(22, 'setor-tanggal-no', '', 'siswa', 'Setor', 'Seor tabungan', 0, 1, 'aktif', '2020-10-10 10:45:20'),
	(23, 'bb-tanggal-no', 'siswa', 'koperasi', 'Pembelian Baju Siswa', 'Pembelian Baju siswa tahunan', 2500000, 1, 'aktif', '2020-10-10 03:47:19'),
	(24, '65-tanggal-no', 'siswa', 'koperasi', 'sdfsdfsd54f65', 'asdsadasdamkl5654', 5555, 1, 'tidak', '2020-10-28 11:10:36');
/*!40000 ALTER TABLE `tb_mastertransaksi` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_menu: ~5 rows (approximately)
/*!40000 ALTER TABLE `tb_menu` DISABLE KEYS */;
REPLACE INTO `tb_menu` (`id_menu`, `menu`, `icon`, `urutan`) VALUES
...
-- Dumping data for table db_bms.tb_provinsi: ~34 rows (approximately)
/*!40000 ALTER TABLE `tb_provinsi` DISABLE KEYS */;
REPLACE INTO `tb_provinsi` (`id_provinsi`, `name_prov`) VALUES
	('11', 'ACEH'),
	('12', 'SUMATERA UTARA'),
	('13', 'SUMATERA BARAT'),
	('14', 'RIAU'),
...
-- Dumping data for table db_bms.tb_siswa: ~36 rows (approximately)
/*!40000 ALTER TABLE `tb_siswa` DISABLE KEYS */;
REPLACE INTO `tb_siswa` (`nis`, `namasiswa`, `alamat`, `tempat_lahir`, `tgl_lahir`, `provinsi`, `kota`, `kecamatan`, `jk`, `id_kelas`, `tgl_update`, `id_user`, `status`, `id_tipeuser`, `password`, `rfid`, `id_tahunakademik`) VALUES
	('4445', 'as', 'a', 'Surabaya', '26-10-2020', '34', '3402', '3402130', 'Perempuan', 9, '2020-10-28 21:52:15', 1, 'tidak aktif', 2, 'siswa123', '002132132154', 7),
	('4531', 'ABDUL HAFIIDH EKA PUTRA', ' ', '', '', '', '', '', 'Laki-laki', 7, '2020-10-29 14:43:29', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4534', 'ACHMAD DANDI BHAKTI SAMODRA', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4546', 'AISYAH EKA FITRIANI', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4569', 'APRINDO WAHYU SATRIO', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4608', 'DIAH NUR FADILAH', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4622', 'DURROTUN FADHILAH MAULIDYA', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4626', 'DWI FITRIASIH', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4633', 'EIFFEL BINTANG RACHMALIA', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4644', 'ERINDA EKA LARASATI', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4687', 'IKA LAILIYATUL MUNIROH', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4697', 'KHOIRUDIN FEBRIAN NUR  HABIB', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4698', 'KHOIRUN NISA\'', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4717', 'MAULIA AZZAHRA JASMINE', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4721', 'MICHELLE AUREL TESSALONIKA', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4730', 'MOCHAMAD ROZAQ BINTANG HIDAYATULLOH', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4738', 'MUHAMMAD ALIYUDIN ATAMSYAH', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4741', 'MUHAMMAD FATKUR ROHMAN', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4744', 'MUHAMMAD IRGY KURNIAWAN UMAR', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4746', 'NADINDRA AQILAH PRYATAMA', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4783', 'PUTERI WIKAN AGUSTIN', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4796', 'RANGGA ADI PUTRA', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4805', 'REZA APRIANDI PRATAMA FIRMANSYAH', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4815', 'RISYA FIRDAUS', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4821', 'SANDIKA LYANDRA PRASETYO', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4831', 'SHERCYVIA YONITA REFLYN', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4857', 'TAUFIQ TRI WINARDI', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4859', 'THALIA DWINDA MAYANGSARI', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4861', 'TIRZA WAHONO', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4885', 'YESA DWI PRATIWI', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4888', 'YHOAN ATMA BARATA', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6);
REPLACE INTO `tb_siswa` (`nis`, `namasiswa`, `alamat`, `tempat_lahir`, `tgl_lahir`, `provinsi`, `kota`, `kecamatan`, `jk`, `id_kelas`, `tgl_update`, `id_user`, `status`, `id_tipeuser`, `password`, `rfid`, `id_tahunakademik`) VALUES
	('4890', 'YOEL RAPHAEL PERES', ' ', '', '', '', '', '', 'Laki-laki', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4897', 'ZAHRA NAYLA PUTRI', ' ', '', '', '', '', '', 'Perempuan', 9, '2020-10-26 22:17:21', 1, 'aktif', 2, 'siswa123', ' ', 6),
	('4949', 'Carter Barang', 'hdjhagdjhasgd', 'Surabaya', '2020-10-28', '13', '1304', '1304070', 'Laki-laki', 9, '2020-10-28 22:43:19', 1, 'aktif', 2, 'siswa123', '65479', 6),
	('6464', 'asdjashdhik3113', 'a464a64dd6a4ad', 'asdasdas', '30-09-2020', '82', '8271', '8271021', 'Laki-laki', 9, '2020-10-28 21:52:32', 1, 'tidak aktif', 2, 'siswa123', '454498979546a', 5),
	('9965', 'Dimas Aji', ' ', 'Surabaya', '2020-10-20', '21', '2101', '2101024', 'Laki-laki', 1, '2020-10-25 18:17:08', 1, 'alumni', 2, 'siswa123', '0015220756', 3);
...
-- Dumping data for table db_bms.tb_staf: ~9 rows (approximately)
/*!40000 ALTER TABLE `tb_staf` DISABLE KEYS */;
REPLACE INTO `tb_staf` (`id_staf`, `nopegawai`, `nama`, `alamat`, `provinsi`, `kota`, `kecamatan`, `tlp`, `id_tipeuser`, `status`, `tgl_upddate`, `id_user`, `password`) VALUES
	(1, 'coba', 'sdasdasd', ' Jl.Kandanganlasdadasdasdasdasdasdasdasdasdasdasda', '51', '5104', '5104030', '084563252135', 0, 'aktif', '2020-10-28 09:22:55', 1, NULL),
	(2, '000000000002', 'Choirul Anam', 'JL - Wonorejo 3  / 140', '35', '3529', '3529020', '083108763291', 1, 'tidak aktif', '2020-09-20 11:51:12', 1, 'pegawai123'),
	(3, '00000000003', 'Dian', 'Jl.Sememi', '81', '8108', '8108071', '023145618954', 1, 'tidak aktif', '2020-09-20 02:49:48', 1, 'pegawai123'),
	(4, ' fdgdfg', 'asd654ll', 'asd', '19', '1901', '1901080', '1234567', 1, 'tidak aktif', '2020-09-21 12:51:44', 1, 'pegawai123'),
	(5, 'asdd asdasd', 'Dani Cahyaasdasdasd', 'qwe', '53', '5318', '5318040', '085265432589', 1, 'aktif', '2020-10-28 09:24:33', 1, 'pegawai123'),
	(6, 'masbek', 'Administrasi', '-', '11', '1101', '1101010', '000000000000', 1, 'tidak aktif', '2020-09-21 10:28:08', 1, 'pegawai123'),
	(7, '123123', 'danisadasd', 'jl.kandangan jaya', '51', '5104', '5104040', '025465135464', 1, 'aktif', '2020-10-28 09:24:42', 1, 'pegawai123'),
	(8, '123456789 as', 'Gus Andiasdsaddasd', 'Jl.Benowo asd', '51', '5103', '5103020', '085536928693', 1, 'aktif', '2020-10-28 09:24:51', 1, 'pegawai123'),
	(9, '12312321', '12321312', 'aasdasd', '11', '1103', '1103020', '085536928693', 1, 'aktif', '2020-10-28 09:25:21', 1, NULL);
/*!40000 ALTER TABLE `tb_staf` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_submenu: ~20 rows (approximately)
/*!40000 ALTER TABLE `tb_submenu` DISABLE KEYS */;
REPLACE INTO `tb_submenu` (`id_submenu`, `id_menus`, `submenu`, `linksubmenu`, `statusmenu`) VALUES
	...
	(21, 1, 'Histori Transaksi', 'siswa-histori/', 'aktif'),
	(23, 2, 'Transaksi', 'transaksi/', 'aktif'),
	(25, 1, 'Pengguna', 'users/', 'aktif');
/*!40000 ALTER TABLE `tb_submenu` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_tahunakademik: ~4 rows (approximately)
/*!40000 ALTER TABLE `tb_tahunakademik` DISABLE KEYS */;
REPLACE INTO `tb_tahunakademik` (`id_tahunakademik`, `tglawal`, `tglakhir`, `id_user`, `tglupdate`) VALUES
	(3, '2019-06-01', '2020-06-01', 1, '2020-10-28 02:44:35'),
	(5, '2020-06-01', '2021-06-25', 1, '2020-10-25 03:03:03'),
	(6, '2021-06-01', '2022-06-01', 1, '2020-10-25 03:03:25'),
	(7, '2022-06-01', '2023-06-01', 1, '2020-10-25 03:04:04');
/*!40000 ALTER TABLE `tb_tahunakademik` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_tipeuser: ~2 rows (approximately)
/*!40000 ALTER TABLE `tb_tipeuser` DISABLE KEYS */;
REPLACE INTO `tb_tipeuser` (`id_tipeuser`, `tipeuser`) VALUES
	(1, 'staf'),
	(2, 'siswa');
/*!40000 ALTER TABLE `tb_tipeuser` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_transaksi: ~5 rows (approximately)
/*!40000 ALTER TABLE `tb_transaksi` DISABLE KEYS */;
REPLACE INTO `tb_transaksi` (`id_transaksi`, `tipeuser`, `id_anggota`, `id_siswa`, `id_jenistransaksi`, `kodetransaksi`, `keterangan`, `nominal`, `status_jurnal`, `id_user`, `tgl_update`, `status`) VALUES
	(0, 'siswa', NULL, 4531, 19, 'spp-20201023-1', 'PEMBAYARAN SPP SISWA BULAN JANUARI', 300000, '1', 1, '2020-10-23 05:27:45', 'aktif'),
	(63, 'siswa', NULL, 4531, 19, 'spp-20201023-1', 'PEMBAYARAN SPP SISWA BULAN JANUARI', 300000, '1', 1, '2020-10-23 05:39:59', 'aktif'),
	(64, 'siswa', NULL, 4531, 18, 'isisaldo-20201023-1', 'ISI SALDO KARTU KREDIT SISWA', 1000000, '1', 1, '2020-10-23 05:41:51', 'aktif'),
	(66, 'siswa', NULL, 4531, 18, 'isisaldo-20201010-3', 'ISI SALDO KARTU KREDIT SISWA', 1000000, '0', 1, '2020-10-10 15:29:45', 'aktif'),
	(67, 'siswa', NULL, 4534, 18, 'isisaldo-20201010-4', 'ISI SALDO KARTU KREDIT SISWA', 1000000, '0', 1, '2020-10-10 15:30:00', 'aktif');
...
-- Dumping data for table db_bms.tb_userlevel: ~2 rows (approximately)
/*!40000 ALTER TABLE `tb_userlevel` DISABLE KEYS */;
REPLACE INTO `tb_userlevel` (`id`, `userlevel`) VALUES
	(1, 'administrator'),
	(2, 'anggota');
/*!40000 ALTER TABLE `tb_userlevel` ENABLE KEYS */;
...
-- Dumping data for table db_bms.tb_userlog: ~186 rows (approximately)
/*!40000 ALTER TABLE `tb_userlog` DISABLE KEYS */;
REPLACE INTO `tb_userlog` (`id_userlog`, `id_user`, `waktu`, `id_submenu`, `ket`) VALUES
...
-- Dumping data for table db_bms.tb_users: ~1 rows (approximately)
/*!40000 ALTER TABLE `tb_users` DISABLE KEYS */;
REPLACE INTO `tb_users` (`id`, `nama`, `username`, `password`, `user_level`) VALUES

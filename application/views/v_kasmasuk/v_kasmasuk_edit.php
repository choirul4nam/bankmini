                            ...
                            <form action="<?= base_url('kasmasuk/ubahdata') ?>" method="POST">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <?php $date = date('Y-m-d', strtotime($km['tgltransaksi'])) ?>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"><textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control" required><?= $km['keterangan'] ?></textarea></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Nominal
                                        ...
                                        <td colspan="4">
                                            ...
                                            <input type="text" class="form-control" id="inputNominal" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required name="no" value="Rp. <?= number_format($km['nominal'], 0, '', '.') ?>">
                                            <input type="hidden" name="nominal" id="nominal" value="<?= $km['nominal'] ?>">
                                        </td>
                                    </tr>
